...
from autohsca.core.sca_nn_model import SCANNModel


# Model Code from ASCAD Paper Github Repository (https://github.com/ANSSI-FR/ASCAD)
class ASCADMLPBaseline(SCANNModel):
    def __init__(self, model_name, num_classes, input_dim, n_units=200, n_hidden=5, kernel_regularizer=None,
                 kernel_initializer="glorot_uniform", optimizer=RMSprop(learning_rate=0.00001),
