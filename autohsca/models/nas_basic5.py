...
from autohsca.constants import NAS_MODEL
from autohsca.core import *
from autohsca.core.extension_blocks import DenseBlockExt, ClassificationHeadFixed


class NASBasic5(NASModel):
    def __init__(self, model_name, num_classes, input_dim, dataset, max_trials=100, objective='val_accuracy',
        ...
        super(NASBasic5, self).__init__(model_name=model_name, num_classes=num_classes, input_dim=input_dim,
                                        dataset=dataset, model_directory=NAS_MODEL, max_trials=max_trials, objective=objective,
